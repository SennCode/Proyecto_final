...
function Patterns_Women_Dresses() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Patterns / Women / dresses</p>
          <a
          ...
          <div className="row ">
            {store.patterns.length
              ? store.patterns.map((file, id) =>
                  file.gender == "Women" && file.type_clothes == "Dresses" ? (
...
export default Patterns_Women_Dresses;
