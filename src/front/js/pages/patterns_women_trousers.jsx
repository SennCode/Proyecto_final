...
function Patterns_Women_Trousers() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Patterns / Women / trousers</p>
          <a
          ...
          <div className="row ">
            {store.patterns.length
              ? store.patterns.map((file, id) =>
                  file.gender == "Women" && file.type_clothes == "Trousers" ? (
...
export default Patterns_Women_Trousers;
