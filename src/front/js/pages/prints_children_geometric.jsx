...
function Prints_Children_Geometric() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Prints / Children / Geometric</p>
          <a
          ...
          <div className="row ">
            {store.prints.length
              ...
              file.gender == "Children" && file.type_clothes == "Geometric" ? (
...
export default Prints_Children_Geometric;
