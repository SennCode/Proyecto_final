...
function Patterns_Children_Hoodies() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Patterns / Children / hoodies</p>
          <a
          ...
          <div className="row ">
            {store.patterns.length
              ? store.patterns.map((file, id) =>
                  file.gender == "Children" && file.type_clothes == "Hoodies" ? (
...
export default Patterns_Children_Hoodies;
