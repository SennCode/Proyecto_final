...
function Files3D_Children_Trousers() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
            <p className="text-muted">3Dfiles / Children / trousers</p>
          <a
...
export default Files3D_Children_Trousers;
