...
function Patterns_Children_Tshirts() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Patterns / Children / t-shirt</p>
          <a
          ...
          <div className="row ">
            {store.patterns.length
              ? store.patterns.map((file, id) =>
                  file.gender == "Children" && file.type_clothes == "T-Shirt" ? (
...
export default Patterns_Children_Tshirts;
