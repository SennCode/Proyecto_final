...
function Prints_Children_Sports() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Prints / Children / Sports</p>
          <a
          ...
          <div className="row ">
            {store.prints.length
              ...
              file.gender == "Children" && file.type_clothes == "Sports" ? (
...
export default Prints_Children_Sports;
