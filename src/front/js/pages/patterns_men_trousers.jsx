...
function Patterns_Men_Trousers() {
    ...
    <>
      {loader ? (
        ...
        <div className="container-fluid padindg_category_list p_card_gender">
          <p className="text-muted">Patterns / Men / trousers</p>
          <a
          ...
          <div className="row ">
            {store.patterns.length
              ? store.patterns.map((file, id) =>
                  file.gender == "Men" && file.type_clothes == "Trousers" ? (
...
export default Patterns_Men_Trousers;
